defmodule WheelieGoodEatsWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(WheelieGoodEatsWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(WheelieGoodEatsWeb.Gettext, "errors", msg, opts)
    end
  end
